...
const courses = [
  ...
  { name: "Java Training in Chennai", desc: "Build Java programming skills and understand concepts used in modern software and application development.", path: "/courses/programming-courses/java-training-in-chennai", cta: "View Java Course", img: "/Java CLH.png" },
  { name: "Full Stack Development Training in Chennai", desc: "Learn frontend and backend technologies required to develop complete web applications.", path: "/courses/programming-courses/full-stack-developer-training-in-chennai", cta: "View Full Stack Course", img: "/course.jpg" },
