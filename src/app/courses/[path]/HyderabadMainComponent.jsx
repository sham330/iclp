...
export default function HyderabadMainComponent({ course }) {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-white">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-blue-400 font-semibold text-sm uppercase tracking-wider">Hyderabad</span>
              </div>
      ...
      <section className="py-12 bg-[#0a0f2e]">
        <div className="w-full px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-3">
            Ready to Start Your {course.course_name} Journey in Hyderabad?
          </h2>
