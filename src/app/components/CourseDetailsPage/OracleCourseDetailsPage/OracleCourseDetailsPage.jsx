...
import RelatedCoursesSlider from "../../RelatedCourses/RelatedCourses";
import CourseReviews from "../../CourseReviews/CourseReviews";
import CourseAdvantagesTools from "../../CourseAdvantagesTools/CourseAdvantagesTools";
import CourseFAQs from "../../faq/faq";
...
const OracleCourseDetailsPage = () => {
  ...
  "oracle-procure-to-pay-training-in-chennai": {
  ...
  "oracle-hyperion-epm-training-in-chennai": {
  ...
  "oracle-grc-control-suit-fundamentals-vers-training-in-chennai": {
  ...
  "oracle-application-framework-training-in-chennai": {
  ...
  "oracle-cloud-infrastructure-training-in-chennai": {
  ...
  "oracle-weblogic-server-training-in-chennai": {
  ...
  "oracle-customercare-training-in-chennai": {
  ...
  "oracle-r12-training-in-chennai": {
  ...
  "oracle-tax-reporting-training-in-chennai": {
  ...
  "oracle-order-management-training-in-chennai": {
