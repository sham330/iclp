...
const Footer = () => {
  ...
  const allCourses = [
    ...
    { name: "Java", url: "/courses/programming/java-training-in-chennai" },
    { name: "R Programming", url: "/courses/programming/r-programming-training-in-chennai" },
    { name: "JavaScript", url: "/courses/programming/java-script-training-in-chennai" },
    { name: "PHP", url: "/courses/programming/php-training-in-chennai" },
    { name: "Node.js", url: "/courses/web-development/node-js-training-in-chennai" },
    { name: "ReactJS", url: "/courses/web-development/react-js-training-in-chennai" },
    { name: "Angular", url: "/courses/web-development/angular-developer-training-in-chennai" },
    ...
    { name: "Microsoft Azure", url: "/courses/cloud-computing-devops/microsoft-azure-training-in-chennai" },
    { name: "AWS", url: "/courses/cloud-computing-devops/aws-training-in-chennai" },
    ...
    { name: "Cyber Security", url: "/courses/cybersecurity-ethical-hacking/cyber-security-training-in-chennai" },
    { name: "Ethical Hacking", url: "/courses/cybersecurity-ethical-hacking/ethical-hacking-training-in-chennai" },
    { name: "Selenium", url: "/courses/software-testing-quality-assurance/selenium-training-in-chennai" },
    { name: "Manual Testing", url: "/courses/software-testing-quality-assurance/manual-testing-training-in-chennai" },
    { name: "JMeter", url: "/courses/software-testing-quality-assurance/jmeter-training-in-chennai" },
    { name: "Artificial Intelligence", url: "/courses/data-science-artificial-intelligence/artificial-intelligence-training-in-chennai" },
    { name: "Machine Learning", url: "/courses/data-science-artificial-intelligence/machine-learning-training-in-chennai" },
    { name: "Data Science", url: "/courses/data-science-artificial-intelligence/data-science-training-in-chennai" },
    { name: "Power BI", url: "/courses/data-science-artificial-intelligence/power-bi-training-in-chennai" },
    { name: "Digital Marketing", url: "/courses/digital-marketing-business-tools/digital-marketing-training-in-chennai" },
    { name: "UI and UX", url: "/courses/ui-and-ux/ui-ux-designer-training-in-chennai" },
    { name: "Salesforce", url: "/courses/crm-enterprise-solutions/salesforce-training-in-chennai" },
    ...
    { name: "MySQL", url: "/courses/database-management-system/msql-training-in-chennai" },
    { name: "Excel", url: "/courses/microsoft/microsoft-excel-training-in-chennai" },
    { name: "CCNA", url: "/courses/networking/ccna-training-in-chennai" },
  ];
