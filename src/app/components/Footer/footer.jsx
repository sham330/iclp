...
const Footer = () => {
  ...
  const allCourses = [
    ...
    { name: "Data Science Course", url: "/courses/data-science-course-online/" },
    ...
    { name: "C Sharp", url: "/courses/c-sharp-online-training/" },
    ...
    { name: "Machine Learning with Python", url: "/courses/machine-learning-using-python/" },
    { name: "Machine Learning using R", url: "/courses/machine-learning-using-r-course/" },
    { name: "MySQL", url: "/courses/msql-online-training-in-chennai/" },
    { name: "SQL with PHP", url: "/courses/sql-with-php-online-training/" },
    { name: "Microsoft Dynamics 365", url: "/courses/microsoft-dynamics-online-training/" },
    { name: "Excel Macros and VBA", url: "/courses/excel-macros-and-vba-online-training/" },
