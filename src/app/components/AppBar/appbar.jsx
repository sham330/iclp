...
const AppBar = () => {
  ...
  useEffect(() => {
    const courses = [
      ...
      { name: "Network Security", path: "system-network-security-training" },
      { name: "CEH Preparation", path: "ceh-advanced-training" },
      { name: "Cloud Security", path: "ccsk-foundation-training" },
      { name: "Docker", path: "docker-training" },
      { name: "SOC Analyst", path: "soc-analyst-csa-training" },
      { name: "Git & GitHub", path: "git-github-training" },
      { name: "Terraform", path: "terraform-training" },
      { name: "Dotnet Fullstack", path: "dotnet-fullstack-training" },
      { name: "Kubernetes Training", path: "kubernetes-training" },
      ...
      { name: "Mobile App development", path: "mobile-app-development-certification-course" },
      {name:"RAG Systems",path:"rag-systems-ai-certification-course"},
      ...
      { name: "OOPs", path: "oops-concepts-training" },
