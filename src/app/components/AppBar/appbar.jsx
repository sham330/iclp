...
const AppBar = () => {
  ...
  useEffect(() => {
    ...
    fetch("/data/courses.json")
      ...
      { name: "JavaScript", path: "java-script-online-training-in-chennai" },
      ...
      { name: "Node JS", path: "node-js-online-training-in-chennai" },
      ...
      { name: "React JS", path: "react-js-online-training-in-chennai" },
      { name: "Angular", path: "angular-developer-online-training-in-chennai" },
      { name: "WordPress", path: "wordpress-online-training-in-chennai" },
      { name: "Azure Data Factory", path: "azure-data-factory-training-in-chennai" },
      { name: "HTML", path: "html-developer-online-training-in-chennai" },
      ...
      { name: "Python Full Stack", path: "python-full-stack-developer-online-training-in-chennai" },
      { name: "Groovy and Grails", path: "groovy-and-grails-online-training" },
      { name: "Workday HCM", path: "workday-hcm--training-in-chennai" },
      { name: "Salesforce", path: "salesforce-online-training-in-chennai" },
      ...
      { name: "Mobile App development", path: "mobile-app-development-certification-course-training-in-chennai" },
      ...
      { name: "Bootstrap", path: "bootstrap-course-training-in-chennai" },
      ...
      { name: "AWS", path: "aws-online-training-in-chennai" },
      { name: "Cisco UCS", path: "cisco-ucs-training" },
      { name: "Cyber Security", path: "cyber-security-online-training-in-chennai" },
      { name: "Ethical Hacking", path: "ethical-hacking--online-training-in-chennai" },
      { name: "CISM", path: "cism-certification-online-training-in-chennai" },
      ...
      { name: "SoapUI", path: "soap-ui-online-training-in-chennai" },
      ...
      { name: "Data Science with Python", path: "data-science-with-python-training-in-chennai" },
      ...
      { name: "Basic Web designing", path: "basic-web-designing-course-in-chennai" },
      { name: "Programming Basics", path: "programming-basics-training" },
      { name: "Basic Graphic Designing", path: "basic-graphic-designing-course-in-chennai" },
      { name: "Digital Literacy", path: "digital-literacy-training" },
      { name: "AI", path: "artificial-intelligence-course-online-training-in-chennai" },
      { name: "ChatGPT", path: "chatgpt-online-course" },
      { name: "MSQL", path: "msql-online-training-in-chennai" },
      { name: "Soft Tech Skills", path: "soft-tech-skills-training", },
      { name: "SQL with PHP", path: "sql-with-php-online-training-in-chennai" },
      { name: "AR VR", path: "ar-vr-technologies-training", },
      { name: "PL/SQL", path: "pl-and-sql-online-training-in-chennai" },
      { name: "Excel", path: "microsoft-excel-online-training-in-chennai" },
      { name: "Microsoft Dynamics", path: "microsoft-dynamics-online-training" },
      { name: "Microsoft Azure", path: "microsoft-azure-online-training-in-chennai" },
      { name: "Excel Macros and VBA", path: "excel-macros-and-vba-online-training" },
      { name: "Digital Marketing", path: "digital-marketing-online-training-in-chennai" },
      {path:"certified-scrum-master-training-chennai", name:"Certified Scrum Master"},
      { name: "UI/UX", path: "ui-ux-designer-online-training-in-chennai" },
      { name: "CCNA", path: "ccna-online-training-in-chennai" },
      ...
      { name: "Unix Shell Scripting", path: "unix-shell-scripting-online-training-in-chennai" },
      { name: "C and C++", path: "c-cpp-programming-course-training-in-chennai" },
      ...
      {name:"SAP WM",type:"sap",path:"sap-wm-in-chennai"},
      { name: "SAP Banking", type: "sap", path: "sap-banking-in-chennai", },
      ...
      { name: "SAP BPC", type: "sap", path: "sap-bpc-in-chennai" },
      { name: "SAP SCM", type: "sap", path: "sap-scm" },
      { name: "SAP Transportation Management", type: "sap", path: "sap-transportation-management-training-in-chennai" },
      ...
      { name: "Oracle Procure to Pay Training", type: "oracle", path: "oracle-procure-to-pay-in-chennai" },
      { name: "Oracle Hyperion EPM Training", type: "oracle", path: "oracle-hyperion-epm-in-chennai" },
      { name: "Oracle GRC Controls Suite Fundamentals", type: "oracle", path: "oracle-grc-control-suit-fundamentals-vers-in-chennai" },
      { name: "Oracle Developer Course", type: "oracle", path: "oracle-developer-in-chennai" },
      ...
      { name: "Oracle Application Framework (OAF)", type: "oracle", path: "oracle-application-framework-in-chennai" },
      { name: "Oracle Cloud Infrastructure (OCI)", type: "oracle", path: "oracle-cloud-infrastructure-in-chennai" },
      { name: "WebLogic Server", type: "oracle", path: "oracle-weblogic-server-in-chennai" },
      { name: "Oracle PeopleSoft HRMS/HCM", type: "oracle", path: "oracle-peoplesoft-training-in-chennai" },
      { name: "Oracle Customer Care & Billing (CC&B)", type: "oracle", path: "oracle-customercare-in-chennai" },
      { name: "R12.x Oracle Inventory Management", type: "oracle", path: "oracle-r12-in-chennai" },
      { name: "R12.2 Oracle E-Business Tax", type: "oracle", path: "oracle-tax-reporting-in-chennai" },
      { name: "R12.x Oracle Order Management", type: "oracle", path: "oracle-order-management-in-chennai" }
    ];
