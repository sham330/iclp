...
const Blog = () => {
  ...
  return (
    <div className="iclp-blog-container">
      <SEO
        title="Learn with the Best Online Institute - Blog & Tips"
        description="Explore expert tips, student success stories, and course updates from the best online learning institute. Stay ahead in programming, design, business, and more with our latest blog posts."
        image="https://drive.google.com/drive/u/0/folders/1SxfUxy5nkpMbPMkit0Szg2eL7TmknHIv"
        url="https://iclptech.in/blog"
      />
